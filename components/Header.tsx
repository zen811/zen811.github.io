    ...
    <header className="sticky top-0 z-50 bg-[#181410]/80 backdrop-blur-md border-b border-white/10 px-4 md:px-10 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2 text-[#ff8000] cursor-pointer" onClick={() => window.location.hash = '#'}>
        ...
        <div className="flex items-center gap-6">
          <nav className="hidden lg:flex items-center gap-6">
            <a className="text-sm font-medium hover:text-[#ff8000] transition-colors" href="#">Find Rooms</a>
            <a className="text-sm font-medium hover:text-[#ff8000] transition-colors" href="#">My Bookings</a>
            <a className="text-sm font-medium hover:text-[#ff8000] transition-colors" href="#">About Us</a>
          </nav>
